        ...
        <div className="home-section-body home-intro">
          ...
          <ul className="home-intro-list">
            <li>
              ...
              ：瀏覽全部種子，依名稱、生長時間、採集地點篩選與排序；點選列可開啟詳情，並可一鍵複製作物名稱。
            </li>
            <li>
              <strong>種子詳情</strong>
              ：檢視單一種子的說明、已確認雜交表（支援多語搜尋）、作物／種子產量，以及盆栽染色等相關資訊。
            </li>
            <li>
              <Link to="/cross" className="seed-name-link">
                雜交計算器
              </Link>
              ：輸入兩個親本推算雜交結果，或由目標種子反查可能的另一親本。
            </li>
            <li>
              <Link to="/fields" className="seed-name-link">
                田地管理
              </Link>
              ：在格狀田地上配置種子、輔助版面規劃、收成時間預估；田地資料儲存在本機，關閉分頁或瀏覽器後仍會保留。
            </li>
          </ul>
